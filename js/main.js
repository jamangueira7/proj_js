...
function getTotal(list) {
    ...
    document.getElementById("totalValue").innerText = formatValue(total);
}

function setList(list) {
    var table = '<thead><tr><th>Description</th><th>Amount</th><th>Valeu</th><th>Action</th></tr></thead><tbody>';
    for (var key in list){
